...
func NewRemoteTranscoder(m *RemoteTranscoderManager, stream net.Transcoder_RegisterTranscoderServer) *RemoteTranscoder {
...
func (rtm *RemoteTranscoderManager) Manage(stream net.Transcoder_RegisterTranscoderServer, capacity int) {
	...
	transcoder := NewRemoteTranscoder(rtm, stream)
